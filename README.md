...
- 🎯 Entry points to execute your program using `python -m <surface_coverage>` or `$ surface_coverage` with basic CLI argument parsing.
...
Awesome surface_coverage created by bscott711
